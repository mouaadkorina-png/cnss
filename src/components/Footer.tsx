...
import { ShieldCheck, Phone, Mail, FileText, CheckCircle2, Heart } from 'lucide-react';
    ...
    <footer className="bg-slate-900 text-slate-400 text-xs border-t border-slate-800 pt-12 pb-8 mt-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-white text-base">GFDS<span className="text-emerald-400">.ma</span></span>
            </div>
            <p className="text-slate-400 text-[11px] leading-relaxed">
              Générateur professionnel de fichiers de Déclaration des Salaires (DS & DSC) pour le portail DAMANCOM de la CNSS Maroc. 100% conforme aux spécifications EDI officielles.
            </p>
          ...
          {/* Col 2 */}
          <div className="space-y-3">
            <h3 className="font-bold text-white text-xs uppercase tracking-wider">Outils & Déclarations</h3>
            <ul className="space-y-2 text-[11px]">
              <li>
                <button onClick={() => setActiveTab('principale')} className="hover:text-emerald-400 transition-colors">
                  Déclaration Principale (DS)
                </button>
              </li>
              <li>
          ...
          {/* Col 3 */}
          <div className="space-y-3">
            <h3 className="font-bold text-white text-xs uppercase tracking-wider">Solutions Entreprises</h3>
            <ul className="space-y-2 text-[11px]">
              <li>
                <button onClick={() => setActiveTab('produits')} className="hover:text-emerald-400 transition-colors">
                  Solutions E-Achat & E-Supply
                </button>
              </li>
              <li>
                <button onClick={() => setActiveTab('produits')} className="hover:text-emerald-400 transition-colors">
              ...
              <li>
                <button onClick={() => setActiveTab('produits')} className="hover:text-emerald-400 transition-colors">
                  Pointeuses biométriques & Contrôle d'accès
                </button>
              </li>
              <li>
                <button onClick={() => setActiveTab('produits')} className="hover:text-emerald-400 transition-colors">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2 text-[11px]">
              <p className="flex items-center gap-2">
                ...
                <a href="tel:+212699052571" className="hover:text-white font-mono">+212 699 052 571</a>
              </p>
              <p className="flex items-center gap-2">
                <Mail className="w-3.5 h-3.5 text-emerald-400" />
                <a href="mailto:boudalia.tareq@gmail.com" className="hover:text-white">boudalia.tareq@gmail.com</a>
              </p>
              <p className="text-slate-500 pt-2">Casablanca, Maroc</p>
              <button
        ...
        <div className="pt-6 border-t border-slate-800 flex flex-wrap items-center justify-between gap-4 text-[11px] text-slate-500">
          <p>© {new Date().getFullYear()} GFDS.ma - Générateur de Fichier Déclaration des Salaires CNSS. Tous droits réservés.</p>
